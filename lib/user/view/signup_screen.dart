                  ...
                  Row(
                    children: [
                      Text(
                        ...
                        style: Theme.of(context).textTheme.headlineMedium?.copyWith(color: PRIMARY_COLOR),
                      ),
                      Text(
                        ' 에 가입하여',
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          if (_idFormKey.currentState!.validate() &&
                            ...
                            JoinRequest request = JoinRequest(memberId: username, password: password, nickname: nickname, intro: intro);
